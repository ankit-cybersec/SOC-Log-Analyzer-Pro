...
# version 25 -----------------------------csv,Email alert system, SQLite Database
...
def generate_csv():
    ...
    messagebox.showinfo(
        "CSV Generated",
        "Attack_Report.csv Created Successfully"
    )
...
def send_email_alert(ip, attempts):
    ...
    msg["Subject"] = "SOC ALERT - High Risk Attack Detected"
